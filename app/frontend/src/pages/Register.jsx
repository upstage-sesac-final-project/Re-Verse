  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6" style={{ background: 'var(--bg-primary)' }}>
      <div className="w-full max-w-xs">
        ...
        <h1 className="text-lg font-bold mb-8" style={{ color: 'var(--text-primary)' }}>회원가입</h1>

        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div>
            <label htmlFor="username" className="block text-xs mb-1.5" style={{ color: 'var(--text-secondary)' }}>사용자 이름</label>
          ...
          <div>
            <label htmlFor="reg-email" className="block text-xs mb-1.5" style={{ color: 'var(--text-secondary)' }}>이메일</label>
          ...
          <div>
            <label htmlFor="reg-password" className="block text-xs mb-1.5" style={{ color: 'var(--text-secondary)' }}>비밀번호</label>
        ...
        <p className="text-xs mt-8" style={{ color: 'var(--text-secondary)' }}>
          이미 계정이 있으신가요?{' '}
          <Link to="/login" className="font-medium" style={{ color: 'var(--accent)' }}>로그인</Link>
        </p>
      </div>
    </div>
  )
