...
| `!` | 오브젝트형 — 애니메이션 없음, 고정 이미지 | 항상 0 |
| `$` | 빅 스프라이트 — 2배 크기 캐릭터 | 0 또는 지정 |
| `!$` | 빅 오브젝트 — 게이트/문 등 대형 오브젝트 | 항상 0 |
...
#### 오브젝트형 (! 접두사, index 항상 0)

| 파일명 | 용도 |
|--------|------|
| `!Chest` | 보물상자 — ChestEvent 기본값 |
| `!Crystal` | 크리스탈 오브젝트 |
| `!Door1` | 일반 문 |
| `!Door2` | 두 번째 문 스타일 |
| `!Flame` | 불꽃 이펙트 |
...
| 파일명 | 용도 |
|--------|------|
| `$BigMonster1` | 대형 몬스터 스프라이트 1 |
| `$BigMonster2` | 대형 몬스터 스프라이트 2 |
...
| BattleEvent (대형 보스) | `$BigMonster1` 또는 `$BigMonster2` | index 0 고정 |
| ChestEvent | `!Chest` | index 0 고정 |
...
| objects | `!Door`, `!Barrel` | `!Door1`, `!Door2`가 정확한 파일명 (Barrel 없음) |
